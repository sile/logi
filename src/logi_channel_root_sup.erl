...
start_child(Channel) ->
    Child = #{id => Channel, start => {logi_channel_sup, start_link, [Channel]}, type => supervisor},
...
init([]) ->
    ...
    Child = #{id => Default, start => {logi_channel_sup, start_link, [Default]}, type => supervisor},
    {ok, {#{}, [Child]}}.
