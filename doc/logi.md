...
<a name="ensure_to_be_instance-1"></a>

### ensure_to_be_instance/1 ###

<pre><code>
ensure_to_be_instance(Logger::<a href="#type-logger">logger()</a>) -&gt; <a href="#type-logger_instance">logger_instance()</a>
</code></pre>
<br />
...
<pre><code>
severity_level(Severity::<a href="#type-severity">severity()</a>) -&gt; 1..8
</code></pre>
<br />
